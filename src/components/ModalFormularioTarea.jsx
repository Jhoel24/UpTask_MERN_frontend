...
const ModalFormularioTarea = () => {
    ...
    const handleSubmit = async e => {
        ...
        await submitTarea({ nombre, descripcion, prioridad, fecha, proyecto: id, idTarea })
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h3" className="text-lg leading-6 font-bold text-gray-900 text-center uppercase tracking-wider">
